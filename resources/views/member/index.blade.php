...
<div class="main-container">
  <div class="row-top">
    <div class="col-sm">
      <form style="display: inline-block;"  action="{{ action('Member\DramasController@index') }}" method="get">
...
<footer class="text-muted">
  <div class="container">
    <p class="float-right">
      <p><a class="btn btn-outline-danger btn-lg" href="{{ url('/member/dramas') }}" role="button">戻る</a></p>
    </p>
  </div>
</footer>
